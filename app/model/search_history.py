...
def get_user_search_history(
    user_id: str, limit: int = 100, action_type: Optional[ActionType] = None, brand_id: Optional[str] = None
) -> List[Dict[str, Any]]:
...
def get_search_analytics(
    user_id: Optional[str] = None, brand_id: Optional[str] = None, days: int = 30
) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            f"Generated analytics for user {user_id}, brand {brand_id}: {total_searches} searches in {days} days"
        )
        return analytics
