...
class InputValidator:
    ...
    MALL_KEYWORDS = [
        'mall', 'shopping', 'center', 'store', 'shop', 'retail',
        'rent', 'price', 'cost', 'fee', 'lease', 'district',
        'location', 'address', 'visitor', 'traffic', 'business',
        'tenant', 'space', 'area', 'floor', 'building'
    ]
