...
class AISearchService:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if response.status_code == 200:
                    ...
                    raise GeminiAPIError(f"API request failed with status {response.status_code}", response.status_code, response.json() if response.content else None)
    ...
    def _validate_criteria(self, criteria: Dict[str, Any]) -> Dict[str, Any]:
        ...
        valid_fields = {
            "mall_name", "mall_type", "avg_daily_visitors", "management_fee_usd", 
            "motorbike_fee_vnd", "car_fee_vnd", "electricity_policy",
            "overtime_fee_policy", "lease_term", "deposit_policy", 
            "payment_policy", "number_of_floors", "total_floor_area_m2",
            "opening_year", "parking_motorbike_spaces", "parking_car_spaces",
            "has_public_transport_access", "has_loading_dock", "has_elevator",
            "has_escalator", "operating_hours_weekday", "operating_hours_weekend",
            "contact_phone", "contact_email", "website", "general_search"
        }
    ...
    def _sanitize_value(self, field: str, value: Any) -> Any:
        ...
        numeric_fields = {"avg_daily_visitors", "management_fee_usd", "motorbike_fee_vnd", 
                         "car_fee_vnd", "number_of_floors", "total_floor_area_m2", 
                         "opening_year", "parking_motorbike_spaces", "parking_car_spaces"}
...
class ElasticsearchService:
    ...
    async def search_malls_with_ai(self, brand_id: str, query: str, ai_service: AISearchService, page: int = 1, size: int = 10) -> dict:
        ...
        try:
            ...
            if not extraction_result["success"]:
                return {
                    "success": False,
                    "error": f"AI extraction failed: {extraction_result['error']}",
                    "results": []
                }
    ...
    def _get_source_fields(self) -> List[str]:
        ...
        return [
            "mall_id", "mall_name", "mall_type", "mall_coordinates", "updated_at",
            "mall_information_id", "number_of_floors", "total_floor_area_m2",
            "avg_daily_visitors", "management_fee_usd", "motorbike_fee_vnd",
            "car_fee_vnd", "electricity_policy", "overtime_fee_policy",
            "lease_term", "deposit_policy", "payment_policy", "opening_year",
            "operating_hours_weekday", "operating_hours_weekend", "contact_phone",
            "contact_email", "website", "parking_motorbike_spaces",
            "parking_car_spaces", "has_public_transport_access",
            "has_loading_dock", "has_elevator", "has_escalator"
        ]
